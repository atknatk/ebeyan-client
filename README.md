# Dinazor Client Framework

[live](http://apps.klcyazilim.com/framework) demo

## Build

[![Build Status](http://jenkins.klcyazilim.com/job/Dinazor-Client/badge/icon)](http://jenkins.klcyazilim.com/job/Dinazor-Client/)
...
|   |       |-- graphs
|   |       ...
|   |       |-- dinazor.config.ts  # dinazor setup file
|   |       |-- dinazor.module.ts  # shared module useful for reexport common functionality
|   |   ...    
...
* adjust navigation `app/shared/layout/navigation/navigation.component.html` 
   * (soon navigation will be configurable via json or `dinazor.config.js`)
...
## resources
- [live project demo](http://apps.klcyazilim.com/framework)

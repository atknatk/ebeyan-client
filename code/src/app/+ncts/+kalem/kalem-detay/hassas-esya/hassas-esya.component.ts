...
@Component({
  selector: 'ncts-kalem-detay-hassas-esya',
  templateUrl: './hassas-esya.component.html',
  styleUrls: ['./hassas-esya.component.css']
})
export class NctsKalemDetayHassasEsyaComponent extends BaseNctsKalemList {
  ...
  constructor(private dnHttpService: DnHttpService<any>,
    ...
    super('NctsKalemHassasEsyaList', 'NctsKalemHassasEsya', activatedRoute, dnHttpService);
  }

...
@Component({
  selector: 'ncts-kalem-detay-konteyner',
  templateUrl: './konteyner.component.html',
  styleUrls: ['./konteyner.component.css']
})
export class NctsKalemDetayKonteynerComponent extends BaseNctsKalemList {
  ...
  constructor(private dnHttpService: DnHttpService<any>,
    ...
    super('NctsKalemKonteynerList', 'NctsKalemKonteyner', activatedRoute, dnHttpService);
  }

...
@Component({
  selector: 'ncts-kalem-detay-onceki-belge',
  templateUrl: './onceki-belge.component.html',
  styleUrls: ['./onceki-belge.component.css']
})
export class NctsKalemDetayOncekiBelgeComponent extends BaseNctsKalemList {
  ...
  constructor(private dnHttpService: DnHttpService<any>,
    ...
    super('NctsKalemOncekiBelgeList', 'NctsKalemOncekiBelge', activatedRoute, dnHttpService);
  }
  ...
  fields(): any[] {
    return [
      ...
      {key: 'tamamlayiciBilgi'},
      {key: 'tamamlayiciBilgiDil'},
      {key: 'id', value: 0},

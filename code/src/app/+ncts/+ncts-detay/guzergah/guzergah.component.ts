...
@Component({
  selector: 'ncts-detay-guzergah',
  templateUrl: './guzergah.component.html',
  styleUrls: ['./guzergah.component.css']
})
export class NctsDetayGuzergahComponent extends BaseNctsList {
  ...
  constructor(private dnHttpService: DnHttpService<any>,
    ...
    super('NctsGuzergahList', 'NctsGuzergah', activatedRoute, dnHttpService);
  }

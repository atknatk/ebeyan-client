...
@Component({
  selector: 'ncts-detay-muhur',
  templateUrl: './muhur.component.html',
  styleUrls: ['./muhur.component.css']
})
export class NctsDetayMuhurComponent extends BaseNctsList {
  ...
  constructor(private dnHttpService: DnHttpService<any>,
    ...
    super('NctsMuhurList', 'NctsMuhur', activatedRoute, dnHttpService);
  }

...
@Component({
  templateUrl: './varisbildirimi-tab.component.html',
  styles: [`
    .li-disabled {
      /* pointer-events: none;*/
      /* opacity: 0.6;*/
...
export class VarisbildirimiTabComponent extends DnLoadingBase implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngOnInit() {
    this.sub = this._route.params.subscribe(params => {
      ...
      this.ozetbeyanComponent.beyanType = beyanConfig.varisbildirimi;
      this.ozetbeyanComponent.loadData(this.idOzetbeyan);
      if (this.tasimaSenetComponent) {
        this.tasimaSenetComponent.beyanType = beyanConfig.varisbildirimi;
